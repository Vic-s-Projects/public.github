# Vic's Projects | Engineering & AI Solutions
...
### 🌟 [AllIWant](https://alliwant.runasp.net/)
**Social Registry & Wishlist Engine**
* **The Problem:** Fragmented gift tracking across multiple retailers and social circles.
* **The Solution:** A unified social registry platform that allows users to centralize desires and share them within a secure social network.
* **Tech Stack:** .NET Core, ASP.NET MVC, MS SQL Server.

### 🗣️ [La Tertulia](https://tertulia.runasp.net/)
**Community-Focused Social Platform**
* **The Focus:** Streamlined interaction and localized networking for specific interest groups.
...
* **Tech Stack:** C#, Windows API Interop, System Registry Hardening.
...
3.  **Governance & Transparency:** Emphasizing clear documentation, strict version control, and clean, maintainable codebases.
...
---
*WillardIT: Specialized business and consumer solutions for a digital world.*
